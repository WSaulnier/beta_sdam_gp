...
if (!is.null(params$aqua_inv)) {
  glue("Total abundance of aquatic macroinvertebrates: ", cat(params$aqua_inv))
} else {
  cat("Data was not provided")
}
```
...
if (!is.null(params$may_flies)) {
  glue("Total abundance of mayflies: ", cat(params$may_flies))
} else {
  cat("Data was not provided")
}
```
...
if (!is.null(params$indicator_families)) {
    glue("Total abundance of perennial indicator families of aquatic macroinvertebrates: ", cat(params$indicator_families))
} else {
  cat("Data was not provided")
}
```
...
if (!is.null(params$indicator_taxa)) {
  glue("Total number of perennial indicator families of aquatic macroinvertebrates: ", cat(params$indicator_taxa))
} else {
  cat("Data was not provided")
}
```
