...
RF_v8 <- readRDS("models/refined/V8_rmGOLDOCH_StratUNC/RF_V8_rmGOLDOCH_StratUNC.rds")
...
Beta_SDAM_GP <- function(
        ...
        df <- tibble(lat = ifelse(is.null(user_lat), 0, user_lat),
                     ...
                     UplandRootedPlants_score = ifelse(is.null(user_Sinuosity_score), 0, user_Sinuosity_score),
