            ...
            tabsetPanel(
                ...
                tabPanel(
                    ...
                    fluidRow(column(12, h4("Step 1: Enter coordinates"), 
                                    div('Enter coordinates in decimal degrees to determine if the site is in the study area and if the site is in the Northern or Southern Plains Strata.'))),
                    ...
                    fluidRow(
                        ...
                        #     5, 
                        #     br(),
                        #     actionButton("snobutton", label="Assess Plains Region")
                        # ),
                        column(
                            2,
                            ""
                    ...
                    fluidRow(
                      column(
                        ...
                        h4(HTML("Step 2: Enter required indicator data")),
                        ...
                        fluidRow(
                          ...
                          column(
                            6,
                            h6("Total abundance of EPT Taxa")
                          )
                        ),
                        ...
                        fluidRow(
                          ...
                          column(
                            6,
                            h6("Total abundance of hydrophytic vegetation")
                          )
                        ),
                        ...
                        fluidRow(
                            column(width = 12,
                                   sliderInput("select", "Choose the Number of Densiometer Readings (max. 12)", min = 1, max = 12, value = 3)
                            )
                        ),
                        fluidRow(
                            column(
                        ...
                        h5(HTML("<b>Geomorphic indicators</b>")),
                        fluidRow(
                            column(
                                12,
                                radioButtons(
                        ...
                        fluidRow(
                          column(
                            ...
                            radioButtons(
                              ...
                              HTML("<b><i>Channel Dimensions</b></i>"),
                              c(
                                "0 (Poor)" = 0,
                                "1.5 (Moderate)" = 1.5,
                                "3 (Strong)" = 3
                        ...
                        fluidRow(
                            column(width = 12,
                                   sliderInput("select_bank", "Choose the Number of Densiometer Readings (max. 12)", min = 1, max = 3, value = 3)
                            )
                        ),
                        fluidRow(
                            column(
                            ...
                            column(
                                h2(HTML("<b>Mean Bankful Width</b>")),
                                width = 6,
                    ...
                    conditionalPanel(
                       ...
                       HTML('<hr style="color: black; height: 6px; background-color: black;">'),
                       h4(HTML(
                           "<b>Observed Geomorphic</b>")
                       ),
                       numericInput(
                           inputId = "val_slope",
                           label = "Valley slope percent:",
                           value = 0,
                           min = 0,
                       ),
                       radioButtons(
                           "riffle_pool", 
                           HTML("Riffle Pool Sequence Score"),
                           c(
                               "0 (Poor)" = 0,
                               "0.5" = 0.5,
                               "1 (Weak)" = 1,
                       ...
                       textAreaInput(
                           inputId = "notes_riffle_pool",
                           label = "Comments on riffle pool sequence:",
                           value = "",
                           width = '300px',
                           height = '300px',
                           placeholder = NULL
                       ...
                       radioButtons(
                           inputId = "seeps",
                           label = "Presence/absence of springs or seeps within one-half channel width of the channel:",
                           choices = c(
                               "Present" = 'present',
                       ...
                       radioButtons(
                           "sediment_deposition", 
                           HTML("Sediment on Plants/Debris Score"),
                           c(
                               "0 (Poor)" = 0,
                               "0.5" = 0.5,
                               "1 (Weak)" = 1,
                       ...
                       textAreaInput(
                           inputId = "notes_sediment_depostion",
                           label = "Comments on riffle pool sequence:",
                           value = "",
                           width = '300px',
                           height = '300px',
                       ...
                       radioButtons(
                           "water_channel", 
                           HTML("Visual estimate of the water in the channel:"),
                           c(
                               "0 (Poor)" = 0,
                               "1" = 1,
                               "2" = 2,
                       ...
                       textAreaInput(
                           inputId = "notes_water_channel",
                           label = "Comments on water in channel:",
                           value = "",
                           width = '300px',
                           height = '300px',
                           placeholder = NULL
                       ...
                       radioButtons(
                           "hydric_soils", 
                           label = "Presence/absence of hydric soils within the channel",
                           c(
                               "0 (Poor)" = 0,
                               "1 (Weak)" = 1,
                               "2 (Moderate)" = 2,
                       ...
                       textAreaInput(
                           inputId = "notes_hydric",
                           label = "Comments on hydric soils:",
                           value = "",
                           width = '300px',
                           height = '300px',
                           placeholder = NULL
                       ...
                       numericInput(
                           inputId = "woody_jams",
                           label = "Number of woody jams in the channel:",
                           value = 0,
                           min = 0,
                       ),
                       textAreaInput(
                           inputId = "notes_woody_jams",
                           label = "Comments on observed woody jams:",
                           value = "",
                           width = '300px',
                           height = '300px',
                           placeholder = NULL
                       ...
                       textAreaInput(
                           inputId = "notes_soil_moisture",
                           label = "Comments on soil moisture:",
                           value = "",
                           width = '300px',
                           height = '300px',
                           placeholder = NULL
                       ...
                       HTML('<hr style="color: black; height: 6px; background-color: black;">'),
                       h4(HTML(
                           "<b>Observed Biological</b>")
                       ),
                       radioButtons(
                           "difference_veg", 
                           HTML("Differences in vegetation"),
                           c(
                               "0 (Poor)" = 0,
                               "0.5" = 0.5,
                               "1 (Weak)" = 1,
                           ...
                           textAreaInput(
                               inputId = "notes_difference_veg",
                               label = "Comments on differences in vegetation:",
                               value = "",
                               width = '300px',
                               height = '300px',
                               placeholder = NULL
                       ...
                       ### Channel Dimensions----
                       h4(HTML("<b>Floodplain Channel Dimensions</b>")),
                       # radioButtons(
                       #   inputId = "vegetation_score",
                       #   label = "Differences in vegetation score:",
                       #   choices = c(
...
server <- function(input, output, session) {
    ...
    output$text <- renderText ({
        paste0(densi_shade_perc(), "%   :   ", densi_shade_dec())
        
    })
    
    # mean bankfull width calculation----
    ...
    # Show user calculated percent value
    output$bank_text <- renderText ({
        paste0("Mean Bank Width (m): ", bank_mean())
    ...
    output$final_class <- renderUI({
        ...
        session$userData$class <- classification() %>% as.character()
